...
object JsDialogProcessor {
                ...
                runIgnoringCancellationException {
                    runBlockingWithCancellationPredicate({ indicator.isCanceled }) {
                        ...
                        AppExecutorUtil.getAppExecutorService().submit {
                            invokeLater {
                                manageExports(file, exports.toList(), editor, project)
                            }
                        }
                    }
                }
    ...
    private fun manageExports(file: File, exports: List<String>, editor: Editor, project: Project) {
        ...
        val fileText = file.readText().replace("\r", "")
